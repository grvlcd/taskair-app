import useSidenavStore from "@/lib/store/app/sidenavStore";
  ...
  return (
    <>
      {isOpen ? (
        /* EXPANDED IF TRUE */
        <div
          className={`flex flex-col items-center w-40 h-full overflow-hidden text-gray-700 bg-gray-100 rounded`}
        >
          <button
            className="flex items-center justify-end w-full px-3 mt-3"
          ...
          <div className="w-full px-2">
            <div className="flex flex-col items-center w-full mt-3 border-t border-gray-300">
              ...
              >
                ...
                <span className="ml-2 text-sm font-medium">Boards</span>
              </Link>
            </div>
          </div>
          <a
        ...
        /* COLLAPSE IF FALSE */
        <div className="flex flex-col items-center w-16 h-full overflow-hidden text-indigo-300 bg-gray-800 rounded rounded-tl-none rounded-tr-none">
          <button
